          ...
          >
            ...
            <VList density="compact">
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: "Jakarta" akan mencari yang benar-benar "Jakarta"</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: "Jakarta" akan mencari selain Jakarta</em>
                </VListItemSubtitle>
              </VListItem>
            </VList>
          </VCard>
          ...
          >
            ...
            <VList density="compact">
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: "Ahmad" akan menemukan "Ahmad Santoso"</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: "ahmad" juga akan menemukan "AHMAD Santoso"</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: "Ahmad" akan mencari semua kecuali yang ada kata "Ahmad"</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: "Dr" akan menemukan "Dr. Ahmad"</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: "com" akan menemukan "ahmad@gmail.com"</em>
                </VListItemSubtitle>
              </VListItem>
            </VList>
          </VCard>
          ...
          >
            ...
            <VList density="compact">
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Umur > 25 atau tanggal setelah 2023-01-01</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Umur < 30 atau tanggal sebelum 2023-12-31</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Umur ≥ 25 akan termasuk yang umur 25</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle>Sama seperti di atas, tapi termasuk nilai yang sama</VListItemSubtitle>
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Umur ≤ 65 akan termasuk yang umur 65</em>
                </VListItemSubtitle>
              </VListItem>
            </VList>
          </VCard>
          ...
          >
            ...
            <VList density="compact">
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Umur antara 20-30 tahun</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Umur di luar 20-30 tahun (kurang dari 20 atau lebih dari 30)</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Pasien yang daftar dari 1 Januari sampai 31 Maret 2023</em>
                </VListItemSubtitle>
              </VListItem>
            </VList>
          </VCard>
          ...
          >
            ...
            <VList density="compact">
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Kota Jakarta, Bandung, Surabaya</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Selain Jakarta, Bandung, Surabaya</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                <VListItemTitle><strong>Cara menulis:</strong></VListItemTitle>
                <VListItemSubtitle class="text-info">
                  Pisahkan dengan koma: Jakarta, Bandung, Surabaya
                </VListItemSubtitle>
              </VListItem>
            </VList>
          </VCard>
          ...
          >
            ...
            <VList density="compact">
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Pasien yang alamatnya belum diisi</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                ...
                <VListItemSubtitle class="text-success mt-1">
                  <em>Contoh: Pasien yang alamatnya sudah diisi</em>
                </VListItemSubtitle>
              </VListItem>
              <VListItem>
                <VListItemTitle><strong>Catatan:</strong></VListItemTitle>
                <VListItemSubtitle class="text-warning">
                  Tidak perlu mengisi nilai apa-apa
                </VListItemSubtitle>
              </VListItem>
            </VList>
          </VCard>
...
// This is a purely presentational component, no props or logic needed
</script> 
